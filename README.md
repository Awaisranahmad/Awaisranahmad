...
⚡  fact    : I turn coffee into clean code ☕ ,Lets connect
```
...
|:---:|:---:|:---:|
| **Flutter Chat App** | Flutter · Firebase · Dart | Real-time messaging, auth, clean UI |
| **AI Chatbot** | Python · OpenAI · REST API | Context-aware, multi-turn conversation |
| **Backend REST API** | Node.js · Express · MongoDB | JWT Auth, CRUD, modular architecture |
| **File Organizer** | Python · OS · Automation | Auto-sorts files by type & date |
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:1e88e5,100:0d47a1&height=120&section=footer&animation=twinkling"/>
